% DEMOC1P27vcf4 Simple demo of probabilistic PCA with noise on p27 dataset.
...
save resultsp27vcf9 model expectations Y varY
figure, nppcaProfilePlotter(model,expectations,Y, varY,160,'p27')